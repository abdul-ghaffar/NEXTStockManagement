                    ...
                    <div className="mb-4 flex items-center gap-3">
                        <div>
                            <button
                                ...
                                className="px-3 py-1.5 rounded-md text-xs font-medium bg-white/90 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                            >
                                Back to Sale
                            </button>
                        </div>
                        ...
                        <div className="lg:col-span-2 flex flex-col h-full overflow-hidden">
                            <div className="flex-none">
                                <div className="mb-3 flex flex-wrap items-center gap-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-3 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-sm">
                                    {/* Back to Sales (always available in items view) */}
                                    <button
                                        onClick={() => router.push('/sale')}
                                        className="px-3.5 py-2 border border-gray-200 dark:border-gray-600 bg-white/80 dark:bg-gray-800 rounded-lg text-xs hover:bg-gray-100 dark:hover:bg-gray-700 transition-all flex items-center gap-2 font-medium text-gray-700 dark:text-gray-200 mr-2"
                                    >
